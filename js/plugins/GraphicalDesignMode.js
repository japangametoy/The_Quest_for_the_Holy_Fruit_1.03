...
(function() {
    ...
    var settings = {
        ...
        Scene_Menu    : {
            ...
            windows : [
                {lines: ["Body count: \\v[2]"], switchId: 0},
		{lines: ["Experiences: \\v[3]"], switchId: 0},
                {lines: ["Rape count: \\v[4]"], switchId: 0},
		{lines: ["Foreplay: \\v[5]"], switchId: 0},
                {lines: ["Sex: \\v[6]"], switchId: 0},
		{lines: ["Prostitution: \\v[12]"], switchId: 0},
                {lines: ["Penetration: \\v[13]"], switchId: 0},
		{lines: ["Orgasms: \\v[14]"], switchId: 0},
                {lines: ["Swallows: \\v[7]"], switchId: 0},
		{lines: ["Boobjobs: \\v[8]"], switchId: 0},
                {lines: ["Bukkakes: \\v[9]"], switchId: 0},
		{lines: ["Creampies: \\v[10]"], switchId: 0},
		{lines: ["Anal: \\v[11]"], switchId: 0},
		{lines: ["Day: \\v[17]"], switchId: 0},
                {lines: ["Reputation: \\v[18]"], switchId: 0},
		{lines: ["\\C[6]Mascot"], switchId: 51},
		{lines: ["\\C[6]Innocent Mascot"], switchId: 52},
		{lines: ["\\C[4]Seductive Mascot"], switchId: 53},
		{lines: ["\\C[4]Sexy Mascot"], switchId: 54},
		{lines: ["\\C[2]Nympho Mascot"], switchId: 55},
		{lines: ["\\C[2]Bitch Mascot"], switchId: 56},
		{lines: ["\\C[10]Trained Mascot"], switchId: 57},
		{lines: ["\\C[10]Pig Slut Poster Girl"], switchId: 58},
		{lines: ["\\C[18]Meat Toilet"], switchId: 59},
		{lines: ["\\C[24]First Experience Memory"], switchId: 61},
		{lines: ["Article Input Template"], switchId: 60},
		{lines: ["Article Template, 2nd line"], switchId: 60},
		{lines: ["A skilled dancer and the group's mascot."], switchId: 62},
		{lines: ["Interested in sex, but still a \\C[10]virgin\\C[0]."], switchId: 62},
		{lines: ["Torsten \\C[10]mistook\\C[0] Lalana for Leah"], switchId: 64},
		{lines: ["while he got drunk on alcohol."], switchId: 64},
		{lines: ["Offered body as \\C[10]compensation\\C[0] for accidentally "], switchId: 67},
		{lines: ["breaking a wristwatch in the clothing store."], switchId: 67},
		{lines: ["The clinic's assistant took her first time "], switchId: 68},
		{lines: ["\\C[10]while she's asleep\\C[0] due to the medicine's side effect."], switchId: 68},
		{lines: ["She somehow became \\C[10]sexually aroused\\C[0] when cleaning"], switchId: 69},
		{lines: ["the share house and had sex with the manager."], switchId: 69},
		{lines: ["\\C[10]Taken home while being drunk\\C[0] after"], switchId: 70},
		{lines: ["reluctantly attending Leah's mixer event."], switchId: 70},
		{lines: ["\\C[10]Had raw rape sex\\C[0] after being\n"], switchId: 71},
		{lines: ["drugged with an aphrodisiac in the VIP room."], switchId: 71},
                {lines: ["Exhibitionist \\v[15]"], switchId: 45},
		{lines: ["\\C[24]Secret Memories"], switchId: 74},
		{lines: ["She felt got so horny while reading an"], switchId: 75},
		{lines: ["erotic novel in her room at the inn and \\C[10]masturbated\\C[0]."], switchId: 75},
		{lines: ["A strange old man she met while helping with"], switchId: 76},
		{lines: ["a delivery job showed her \\C[10]erotic toys\\C[0]."], switchId: 76},
		{lines: ["She was ordered to give a \\C[10]titfuck\\C[0] to"], switchId: 77},
		{lines: ["Leonard while helping out at the House of Healing."], switchId: 77},
		{lines: ["She engaged in \\C[10]sexual acts\\C[0] with a customer while"], switchId: 78},
		{lines: [" helping him in the changing room of the clothing store."], switchId: 78},
		{lines: ["While working as a tutor, a male student wanted her to "], switchId: 79},
		{lines: ["reward him by playing a \\C[10]sexy game\\C[0] with him."], switchId: 79},
		{lines: ["She was violated while sleeping because of the effects of \n"], switchId: 80},
		{lines: ["the medication, but she \\C[10]did not realize\\C[0] she was violated."], switchId: 80},
		{lines: ["She \\C[10]shared her body\\C[0] with the manager"], switchId: 81},
		{lines: ["while cleaning the share house."], switchId: 81},
		{lines: ["She sucked the \\C[10]\"thing\"\\C[0]of a person whose"], switchId: 82},
		{lines: ["face she couldn't see while helping Leah at a certain shop."], switchId: 82},
		{lines: ["She was \\C[10]taken to a special room\\C[0] on the second"], switchId: 83},
		{lines: ["floor of the restaurant after she got drunk and passed out."], switchId: 83},
		{lines: ["She was \\C[10]taken to a hotel\\C[0] after she was forced to"], switchId: 84},
		{lines: ["drink a lot at a mixer she reluctantly attended."], switchId: 84},
		{lines: ["While helping out at the nightclub, she privately"], switchId: 85},
		{lines: ["\\C[10]danced in the toilet\\C[0] for the manager."], switchId: 85},
		{lines: ["She provided \\C[10]special entertainment\\C[0] for nobles"], switchId: 86},
		{lines: ["in the VIP room while helping out at the nightclub."], switchId: 86},
		{lines: ["She got \\C[10]rammed through\\C[0] by multiple men"], switchId: 87},
		{lines: ["in the room where she was hit on and hooked up."], switchId: 87},
		{lines: ["She \\C[10]jerked someone off\\C[0] for compensated dating, "], switchId: 88},
		{lines: ["after being told \"it was just oral\" behind a building."], switchId: 88},
		{lines: ["She was \\C[10]used by an old man\\C[0] on the third "], switchId: 89},
		{lines: ["floor while working as a health service delivery."], switchId: 89},
		{lines: ["While walking around the city at night, she had"], switchId: 90},
		{lines: ["\\C[10]fun going raw\\C[0] because she was good at it."], switchId: 90},
		{lines: ["She reluctantly had to \\C[10]give him a titjob\\C[10] while"], switchId: 91},
		{lines: ["she was on all fours, kneeling and begging until he came."], switchId: 91},
		{lines: ["She \\C[10]helped someone ejaculate\\C[0] because"], switchId: 92},
		{lines: ["he was her type when she was a virgin."], switchId: 92},
		{lines: ["She had unforgettable sex with the share house"], switchId: 93},
		{lines: ["manager so she \\C[10]asked for it\\C[0] in secret."], switchId: 93},
		{lines: ["She picked up a random guy she passed by \n"], switchId: 94},
		{lines: ["on the street because she was \\C[10]too horny\\C[0]."], switchId: 94},
		{lines: ["She serviced the guards working hard for the city"], switchId: 95},
		{lines: ["\\C[10]by using her breasts\\C[0] until they all came."], switchId: 95},
		{lines: ["She was in trouble from being harassed by a drunk and"], switchId: 96},
		{lines: ["\\C[10]gave a blowjob\\C[0] as thanks to the person who saved her."], switchId: 96},
		{lines: ["She was pushed down in Papa's bedroom and using "], switchId: 97},
		{lines: ["the mating press, \\C[10]had sex for hours\\C[0]."], switchId: 97},
		{lines: ["She was approached on her way home and with"], switchId: 98},
		{lines: ["nothing better to do, \\C[10]she went along\\C[0] with him."], switchId: 98},
		{lines: ["She was hit on by an innocent-looking man and"], switchId: 287},
		{lines: ["\\C[10]he played with her body\\C[0], but that was it."], switchId: 287},
		{lines: ["She was hit on and caressed by an innocent-looking man"], switchId: 288},
		{lines: ["but \\C[10]that wasn't enough and she gave him head\\C[0] instead."], switchId: 288},
		{lines: ["She was hit on and caressed by an innocent-looking man"], switchId: 289},
		{lines: ["She was dancing for someone at the nightclub but"], switchId: 289},
		{lines: ["\\C[10]that wasn't enough and she gave him a titfuck\\C[0] instead."], switchId: 290},
		{lines: ["She started secretly working at a brothel and was"], switchId: 290},
		{lines: ["\\C[10]made to cum multiple times\\C[0] in the restroom."], switchId: 291},
		{lines: ["She \\C[10]passionately moved her hips\\C[0] \n\\C[10]while fucking\\C[0] the customer."], switchId: 291},
		{lines: ["She was found out while playing around the city"], switchId: 292},
		{lines: ["naked at night and was \\C[10]forced to have sex\\C[0] until morning."], switchId: 292},
		{lines: ["She was invited to go drink by Torsten, but "], switchId: 99},
		{lines: ["\\C[10]she was sleeping naked\\C[0] when she woke up in the morning."], switchId: 99},
		{lines: ["She brought a man into her room at the inn in the"], switchId: 294},
		{lines: ["afternoon, \\C[10]ditched work, and had fun\\C[0] instead."], switchId: 294},
		{lines: ["In exchange for Leonard to stop hitting on girls,"], switchId: 295},
		{lines: ["she \\C[10]gave her body to him\\C[0] instead."], switchId: 295},
		{lines: ["Torsten and Leah have been feeling stuck in a rut "], switchId: 296},
		{lines: ["lately, so she \\C[10]offered to help\\C[0] them."], switchId: 296},
		{lines: ["She brought a man into her room at the inn late at "], switchId: 297},
		{lines: ["night and \\C[10]fucked like bunnies\\C[0] until morning."], switchId: 297},
		{lines: ["Leonard asked her to take care of his libido"], switchId: 298},
		{lines: ["so she \\C[10]let him fuck her\\C[0] until morning."], switchId: 298},
		{lines: ["She went drinking with Torsten at night, and as things"], switchId: 299},
		{lines: ["progressed, she \\C[10]had sex with him\\C[0] just like that."], switchId: 299},
            ],
        },
        /* 戦闘画面の追加情報 */
        Scene_Battle  : {
